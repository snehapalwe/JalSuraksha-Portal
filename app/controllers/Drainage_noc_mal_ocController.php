	...
	# End of before list statement
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				drainage_noc_mal_oc.commencement_number LIKE ? OR 
				...
				drainage_noc_mal_oc.upload_cc_certificate LIKE ? OR 
...
$modeldata['inspection'] = "-1";
	...
	function revert($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","upload_architech_affidavit","upload_property_location_map","status");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'upload_architech_affidavit' => 'required',
		...
		return $this->render_view("drainage_noc_mal_oc/revert.php", $data);
	}
}
