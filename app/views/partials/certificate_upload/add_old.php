        ...
        <div class="container">
            <div class="row ">
                <div class="col ">
                    ...
                    <strong style='color: black;'>UPLOAD CERTIFICATE</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="certificate_upload-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("certificate_upload/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
