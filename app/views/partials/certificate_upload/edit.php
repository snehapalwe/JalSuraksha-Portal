...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <!--<h4 class="record-title">Edit  Certificate Upload</h4>-->
                    <h4 class="record-title"><strong style='color: black;'>EDIT UPLOADED CERTIFICATE</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("certificate_upload/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <input id="ctrl-rec_id"  value="<?php  echo $data['rec_id']; ?>" type="hidden" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-certificate-holder" class=""> 
                                                <div class="dropzone required" input="#ctrl-certificate" fieldname="certificate"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".pdf" filesize="3" maximum="1">
