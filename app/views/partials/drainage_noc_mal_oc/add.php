...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>NEW DRAINAGE NOC MAL OC APPLICATION</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="drainage_noc_mal_oc-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("drainage_noc_mal_oc/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-commencement_number-holder" class=""> 
                                        <input id="ctrl-commencement_number"  value="<?php  echo $this->set_field_value('commencement_number',""); ?>" type="text" placeholder="Enter COMMENCEMENT NUMBER"  required="" name="commencement_number"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div id="ctrl-zone_id-holder" class=""> 
                                                                    <select required=""  id="ctrl-zone_id" name="zone_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                        ...
                                                                        <?php 
                                                                        $zone_id_options = $comp_model -> drainage_noc_mal_oc_zone_id_option_list();
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div id="ctrl-property_type_id-holder" class=""> 
                                                                                <select required=""  id="ctrl-property_type_id" name="property_type_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php 
                                                                                    $property_type_id_options = $comp_model -> drainage_noc_mal_oc_property_type_id_option_list();
                                                                        ...
                                                                        <fieldset><legend style="color: black; font-size: 20px; font-weight: bold;">REQUIRED APPLICATION RELATED INFORMATION</legend>
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    <label class="control-label" for="mouje_gaon_name">MOUJE OR GOAN NAME <span class="text-danger">*</span></label>
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-zone_property_id-holder" class=""> 
                                                                                                    <select required=""  id="ctrl-zone_property_id" name="zone_property_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                        <option value="">Select a value ...</option>
                                                                                                        <?php 
                                                                                                        $zone_property_id_options = $comp_model -> drainage_noc_mal_oc_zone_property_id_option_list();
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-property_type_as_per_application_id-holder" class=""> 
                                                                                                    <select required=""  id="ctrl-property_type_as_per_application_id" name="property_type_as_per_application_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                        <option value="">Select a value ...</option>
                                                                                                        <?php 
                                                                                                        $property_type_as_per_application_id_options = $comp_model -> drainage_noc_mal_oc_property_type_as_per_application_id_option_list();
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-property_usage_type_id-holder" class=""> 
                                                                                                        <select required=""  id="ctrl-property_usage_type_id" name="property_usage_type_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                            <option value="">Select a value ...</option>
                                                                                                            <?php 
                                                                                                            $property_usage_type_id_options = $comp_model -> drainage_noc_mal_oc_property_usage_type_id_option_list();
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div id="ctrl-election_ward_no_id-holder" class=""> 
                                                                                                                <select  id="ctrl-election_ward_no_id" name="election_ward_no_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                    <option value="">Select a value ...</option>
                                                                                                                    <?php 
                                                                                                                    $election_ward_no_id_options = $comp_model -> drainage_noc_mal_oc_election_ward_no_id_option_list();
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            <label class="control-label" for="computarized_property_no">COMPUTERIZED PROPERTY NO. <span class="text-danger">*</span></label>
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <label class="control-label" for="is_construction_commence_ceriticate_available">IS CONSTRUCTION COMMENCEMENT CERTIFICATE AVAILABLE? <span class="text-danger">*</span></label>
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <label class="control-label" for="commence_ceriticate_number">COMMENCEMENT CERTIFICATE NUMBER <span class='text-danger'>*</span> </label>
                                                                                                                        <div id="ctrl-commence_ceriticate_number-holder" class=""> 
                                                                                                                            <input id="ctrl-commence_ceriticate_number"  value="<?php  echo $this->set_field_value('commence_ceriticate_number',""); ?>" type="text" placeholder="Enter Commence Certificate Number"  name="commence_ceriticate_number"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="form-group ">
                                                                                                                            <label class="control-label" for="commence_ceriticate_date">COMMENCEMENT CERTIFICATE DATE <span class='text-danger'>*</span> </label>
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                ...
                                                                                                                                <div id="ctrl-upload_architech_affidavit-holder" class=""> 
                                                                                                                                    ...
                                                                                                                                    <small class="form-text"><a href='<?php echo SITE_ADDR ?>uploads/MAL_OC_Affidavit.pdf' style="font-weight: bold;">
...
<script> 
    ...
    $rec=$db->getOne("drainage_noc_mal_cc");
    if(isset($rec['id'])){
    ?>
    $("#ctrl-commencement_number").val("<?php echo $rec['application_no'] ?>");
    $("#ctrl-commencement_number").prop("readonly",true);
    <?php
    }
    ?>
 $.getJSON("https://singlewindowsystemkdmc.in/api/common/mal_oc/<?php echo USER_NAME ?>", function(data) {
