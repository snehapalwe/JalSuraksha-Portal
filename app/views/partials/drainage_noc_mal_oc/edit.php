...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Drainage Noc Mal Oc</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("drainage_noc_mal_oc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            <label class="control-label" for="election_ward_no_id">Election Ward No Id <span class="text-danger">*</span></label>
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <label class="control-label" for="is_construction_commence_ceriticate_available">Is Construction Commence Ceriticate Available <span class="text-danger">*</span></label>
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <label class="control-label" for="commence_ceriticate_number">Commence Certificate Number <span class='text-danger'>*</span> </label>
                                                                                                                        <div id="ctrl-commence_ceriticate_number-holder" class=""> 
                                                                                                                            <input id="ctrl-commence_ceriticate_number"  value="<?php  echo $data['commence_ceriticate_number']; ?>" type="text" placeholder="Enter Commence Certificate Number"  name="commence_ceriticate_number"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="form-group ">
