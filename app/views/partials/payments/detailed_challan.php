            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        ...
                        $db->where("payment_mode","","!=");
                        if(!empty($service)){
                        $db->where("db_name", $service);
                        }
                        $services = $jei->GetModel()->rawQuery("SELECT DISTINCT db_name FROM payments ORDER BY db_name");
                        $records = $db->get("payments");
                        /* Service Name Mapping */
                        function service_name_display($name){
                        if($name == "drainage_noc_mal_cc"){
                        return "Drainage NOC MAL CC";
                        }
                        if($name == "drainage_noc_jal_cc"){
                        return "Drainage NOC JAL CC";
                        }
                        if($name == "drainage_noc_jal_oc"){
                        return "Drainage NOC JAL OC";
                        }
                        if($name == "drainage_noc_mal_oc"){
                        return "Drainage NOC MAL OC";
                        }
                        ...
                        <html lang="mr">
                            <head>
                                <meta charset="UTF-8">
                                    <title>KDMC Drainage Detailed Challan Report</title>
                                    <style>
                                        body{
                                                    ...
                                                    <tr>
                                                        <td colspan="6" class="center">
                                                            <div style="margin-bottom:10px;">
                                                                ...
                                                                <h5 style="margin:0;">जल-मल निसारन विभाग</h5>
                                                        ...
                                                        /* Correct Drainage Logic */
                                                        $jei2 = new User_infoController();
                                                        $db2 = $jei2->GetModel();
                                                        $table_name = $data['db_name'];
                                                        $db2->where("paid", $data['id']);
                                                        $prefixDetails = $db2->getOne($table_name, "*");
                                                        $sw_code = $prefixDetails['application_no'] ?? 'N/A';
                                                        ?>
                                                        <tr>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">
                                                                <?= htmlspecialchars($sw_code) ?>
                                                            </td>
                                                            <td class="center">
                                                                <?php
                                                                if (strpos($data['payment_person'], 'TXN') !== false) {
                                                                    echo substr($data['payment_person'], strrpos($data['payment_person'], 'TXN'));
                                                                } else {
                                                                    echo $data['payment_person'];
                                                                }
                                                                ?>
                                                            </td>
                                                            <td class="center">
                                                                <a class="receipt-link" href="<?= SITE_ADDR ?>payments/view/<?= $data['id'] ?>" target="_blank">
                                                                    <?= $data['id'] ?>
                                                                </a>
                                                            </td>
                                                            <td class="right bold">
