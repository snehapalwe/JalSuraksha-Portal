                            ...
                            <div>
                                <input id="ctrl-rec_id"  value="<?php  echo $data['rec_id']; ?>" type="hidden" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-demand-holder" class=""> 
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-payment_person-holder" class=""> 
                                                <input id="ctrl-payment_person"  value="<?php  echo $data['payment_person']; ?>" type="text" placeholder="Enter Payment Person"  required="" name="payment_person"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                            ...
                                            <input id="ctrl-db_name"  value="<?php  echo $data['db_name']; ?>" type="hidden" placeholder="Enter Db Name"  required="" name="db_name"  class="form-control " />
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-payment_chq_no-holder" class=""> 
                                                        <input id="ctrl-payment_chq_no"  value="<?php  echo $data['payment_chq_no']; ?>" type="text" placeholder="Enter Payment Chq No"  required="" name="payment_chq_no"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
