                            ...
                            <div>
                                <input id="ctrl-rec_id"  value="<?php  echo $this->set_field_value('rec_id',""); ?>" type="hidden" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                    <div class="form-group ">
                                        <label class="control-label" for="demand">DEMAND (DO YOU WANT TO GIVE DEMAND TO PAY BY APPLICANT?) <span class="text-danger">*</span></label>
                                        <div id="ctrl-demand-holder" class=""> 
                                            <select required=""  id="ctrl-demand" name="demand"  placeholder="Select a value ..."    class="custom-select" >
                                                ...
                                                $value = $option['value'];
                                                $label = $option['label'];
                                                $selected = $this->set_field_selected('demand', $value, "");
                                                ?>
