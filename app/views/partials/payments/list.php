...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>PAYMENTS</strong></h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-payment_person"> Payment Person</th>
                                                <th  class="td-amount"> Amount</th>
                                                <th  class="td-payment_mode"> Payment Mode</th>
                                                <th  class="td-payment_chq_no"> Payment Chq No</th>
                                                <th  class="td-payment_chq_date"> Payment Chq Date</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-payment_person"> <?php echo $data['payment_person']; ?></td>
                                                <td class="td-amount"> <?php echo $data['amount']; ?></td>
                                                <td class="td-payment_mode"> <?php echo $data['payment_mode']; ?></td>
                                                <td class="td-payment_chq_no"> <?php echo $data['payment_chq_no']; ?></td>
                                                <td class="td-payment_chq_date"> <?php echo $data['payment_chq_date']; ?></td>
