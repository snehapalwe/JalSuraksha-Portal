...
$can_add = ACL::is_allowed("drainage_noc_jal_oc/add");
$can_edit = ACL::is_allowed("drainage_noc_jal_oc/edit");
$can_view = ACL::is_allowed("drainage_noc_jal_oc/view");
$can_delete = ACL::is_allowed("drainage_noc_jal_oc/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>DRAINAGE NOC JAL OC</strong></h4>
                </div>
                <!--<div class="col-sm-3 ">-->
                <!--    <?php if($can_add){ ?>-->
                <!--    <a  class="btn btn btn-primary my-1" href="<?php print_link("drainage_noc_jal_oc/add") ?>">-->
                <!--        <i class="fa fa-plus"></i>                              -->
                <!--        Add New Drainage Noc Jal Oc -->
                <!--    </a>-->
                <!--    <?php } ?>-->
                <!--</div>-->
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('drainage_noc_jal_oc'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('drainage_noc_jal_oc'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="drainage_noc_jal_oc-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                                                            ...
                                                                            // echo "<br>";
                                                                                echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black;'>CERTIFICATE UPLOAD PENDING</span> <br>";
                                                                                    ...
                                                                                    <?php echo "<br>"; ?>
                                                                                        ...
                                                                                        <div class="mb-2">  
                                                                                            <span class="font-weight-light text-muted ">
                                                                                                IS THE CONSTRUCTION COMMENCEMENT CERTIFICATE AVAILABLE?:  
                                                                                            </span>
                                                                                        <?php echo $data['is_construction_commence_ceriticate_available']; ?></div>
                                                                                        <div class="mb-2">  
                                                                                            <span class="font-weight-light text-muted ">
                                                                                                COMMENCEMENT CERITICATE NUMBER:  
                                                                                            </span>
                                                                                    ...
                                                                                    <?php endif; ?>
                                                                                        ...
                                                                                        <?php endif; ?>
                                                                                        <?php if (!empty($data['upload_architect_or_project_consultant_report'])): ?>
                                                                                        <div class="mb-2">
                                                                                            <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                                                UPLOADED ARCHITECT/PROJECT CONSULTANT REPORT:
                                                                                            </strong>  
                                                                                            <a href="<?php echo htmlspecialchars($data['upload_architect_or_project_consultant_report'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                                                target="_blank" 
                                                                                                class="btn btn-info btn-sm">
                                                                                                View Report
                                                                                            </a>
