...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <!--<h4 class="record-title">View  Drainage Noc Mal Cc</h4>-->
                    <h4 class="record-title"><strong style='color: black;'>VIEW DRAINAGE NOC MAL CC CERTIFICATE</strong></h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-applicant_name">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['applicant_name']; ?>" 
                                                ...
                                                data-url="<?php print_link("drainage_noc_mal_cc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-place_or_division_or_village">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['place_or_division_or_village']; ?>" 
                                                ...
                                                data-title="Enter PLACE DIVISION OR VILLAGE" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-zone_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_zone_id_option_list'); ?>' 
                                    ...
                                    <tr  class="td-election_ward_no_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_election_ward_no_id_option_list'); ?>' 
                                    ...
                                    <tr  class="td-property_type_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_property_type_id_option_list'); ?>' 
                                    ...
                                    <tr  class="td-zone_property_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_zone_property_id_option_list'); ?>' 
                                    ...
                                    <tr  class="td-property_type_as_per_application_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_property_type_as_per_application_id_option_list'); ?>' 
                                    ...
                                    <tr  class="td-property_usage_type_id">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/drainage_noc_mal_cc_property_usage_type_id_option_list'); ?>' 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("drainage_noc_mal_cc/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("drainage_noc_mal_cc/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
