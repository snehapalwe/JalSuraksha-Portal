...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>NEW DRAINAGE NOC MAL CC APPLICATION</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="drainage_noc_mal_cc-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("drainage_noc_mal_cc/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-place_or_division_or_village-holder" class=""> 
                                                        <input id="ctrl-place_or_division_or_village"  value="<?php  echo $this->set_field_value('place_or_division_or_village',""); ?>" type="text" placeholder="Enter PLACE DIVISION OR VILLAGE"  readonly required="" name="place_or_division_or_village"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <fieldset><legend style="font-size: 20px; color: black; font-weight: bold;">REQUIRED APPLICATION RELATED INFORMATION</legend>
                                                                        <div class="form-group ">
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-property_usage-holder" class=""> 
                                                                                                <input id="ctrl-property_usage"  value="<?php  echo $this->set_field_value('property_usage',""); ?>" type="text" placeholder="Enter Property Usage"  readonly required="" name="property_usage"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div id="ctrl-upload_architech_affidavit-holder" class=""> 
                                                                                                                        ...
                                                                                                                        <small class="form-text"><a href='<?php echo SITE_ADDR ?>uploads/MAL_CC_Affidavit.pdf' style="font-weight: bold;">
...
<script>
 $.getJSON("https://singlewindowsystemkdmc.in/api/common/mal_cc/<?php echo USER_NAME ?>", function(data) {
