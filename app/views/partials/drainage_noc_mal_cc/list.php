...
$can_add = ACL::is_allowed("drainage_noc_mal_cc/add");
$can_edit = ACL::is_allowed("drainage_noc_mal_cc/edit");
$can_view = ACL::is_allowed("drainage_noc_mal_cc/view");
$can_delete = ACL::is_allowed("drainage_noc_mal_cc/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>DRAINAGE NOC MAL CC</strong></h4>
                </div>
                <!--<div class="col-sm-3 ">-->
                <!--    <?php if($can_add){ ?>-->
                <!--    <a  class="btn btn btn-primary my-1" href="<?php print_link("drainage_noc_mal_cc/add") ?>">-->
                <!--        <i class="fa fa-plus"></i>                              -->
                <!--        Add New Drainage Noc Mal Cc -->
                <!--    </a>-->
                <!--    <?php } ?>-->
                <!--</div>-->
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('drainage_noc_mal_cc'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('drainage_noc_mal_cc'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="drainage_noc_mal_cc-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                <span><?php
                                                    $dbname = "drainage_noc_mal_cc";
                                                    $s = $data['status'];
                                                    // Show status only if NOT 4
                                                    if (!empty($data['inspection']) && in_array(USER_ROLE, [4,5,3])) {
                                                        echo "<a href='".SITE_ADDR."inspection_form/?rec_id={$data['id']}&db_name={$dbname}' class='btn btn-info btn-sm'>View Inspection</a><br><br>";
                                                    }
                                                    if($s == "1"){
                                                    echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black'>PENDING AT AUTH 1</span><br>";
                                                        if(USER_ROLE == 3){
                                                        if($data['inspection']+0!=0 ){
                                                                if($data['inspection']+0 == -1){
                                                        echo "<a href='".SITE_ADDR."inspection_form/add?rec_id=".$data['id']."&db_name=".$dbname."' class='btn btn-danger btn-sm'>Inspection</a><br>";
                                                                }
                                                        echo "<a href='".SITE_ADDR."accept_reject/add?rec_id=".$data['id']."&db_name=".$dbname."' class='btn btn-danger btn-sm'>Accept / Reject</a>";
                                                            }
                                                        else{
                                                        echo "<a href='".SITE_ADDR."inspection_form/add?rec_id=".$data['id']."&db_name=".$dbname."' class='btn btn-danger btn-sm'>Inspection</a><br>";
                                                        echo "<a href='".SITE_ADDR."accept_reject/add?rec_id=".$data['id']."&db_name=".$dbname."&r=force' class='btn btn-danger btn-sm'>Revert</a>";
                                                        }
                                                        }
                                                        }elseif($s == "2"){
                                                        echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black;'>PENDING AT AUTH 2</span><br>";
                                                            if($data['paid'] > 0 && USER_ROLE == 2 && $data['demand'] != "PAID" && $data['demand'] == "YES"){
                                                                
                                                              
                                                                    echo "<br><b><span style='background-color:yellow;color:black'>Pending at citizen for payment</span></b><br>";
                                                                $demand = strtoupper(trim($data['demand']));
                                                                $paid = (int)$data['paid'];
                                                              if(USER_ROLE == 2){
                                                                if($demand == "YES" && $paid != 0){
                                                                echo "<br><a href='".SITE_ADDR."api/paymentsredirect/".$data['paid']."?rec_id=".$data['id']."&db_name=".$dbname."' class='btn btn-danger btn-sm'>Pay Demand</a>";
                                                                }
                                                                }
                                                                ...
                                                                echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black'>PENDING AT AUTH 3</span><br>";
                                                                    ...
                                                                    echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black;'>".$s."</span>";
                                                                    }
                                                                    if($s=="Reverted"){
                                                                        
                                                                        if(USER_ROLE==2){
                                                                    echo "<br><br><a href='".SITE_ADDR."$dbname/revert/".$data['id']."' class='btn btn-danger btn-sm'>EDIT APPLICATION</a>";
                                                                        }
                                                                    echo "<a href='".SITE_ADDR."api/viewreason/$dbname/".$data['id']."' class='btn btn-primary page-modal modal-page btn-sm'>VIEW REASON</a><br>";
                                                                    }
                                                                    // Paid receipt button
                                                                        ...
                                                                        echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black'>PROCESS COMPLETED</span><br>";
                                                                            ...
                                                                            // echo "<br>";
                                                                                ...
                                                                                <?php echo "<br>"; ?>
                                                                                    ...
                                                                                    <div class="mb-2">  
                                                                                        <span class="font-weight-light text-muted ">
                                                                                            PROPERTY SURVEY NO. / CITY SURVEY NO. :  
                                                                                        </span>
                                                                                    ...
                                                                                    <div class="mb-2">  
                                                                                        <span class="font-weight-light text-muted ">
                                                                                            PLACE / DIVISION / VILLAGE FOR PROPERTY :  
                                                                                        </span>
                                                                                    ...
                                                                                    <?php if (!empty($data['upload_floor_plan'])): ?>
                                                                                    <div class="mb-2">
                                                                                        <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                                            UPLOAD FLOOR PLAN:
                                                                                        </strong>  
                                                                                        <a href="<?php echo htmlspecialchars($data['upload_floor_plan'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                                            target="_blank" 
                                                                                    ...
                                                                                    <?php endif; ?>
                                                                                    <?php if (!empty($data['upload_project_consultant_report'])): ?>
                                                                                    <div class="mb-2">
                                                                                        <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                                            PROJECT CONSULTANT REPORT:
                                                                                        </strong>  
                                                                                        <a href="<?php echo htmlspecialchars($data['upload_project_consultant_report'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                                            target="_blank" 
                                                                                            class="btn btn-info btn-sm">
                                                                                            View Report
                                                                                        </a>
