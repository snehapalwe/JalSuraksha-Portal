...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>DRAINAGE NOC JAL CC</strong></h4>
                </div>
                <!--<div class="col-sm-3 ">-->
                <!--    <?php if($can_add){ ?>-->
                <!--    <a  class="btn btn btn-primary my-1" href="<?php print_link("drainage_noc_jal_cc/add") ?>">-->
                <!--        <i class="fa fa-plus"></i>                              -->
                <!--        Add New Drainage Noc Jal Cc -->
                <!--    </a>-->
                <!--    <?php } ?>-->
                <!--</div>-->
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('drainage_noc_jal_cc'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('drainage_noc_jal_cc'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="drainage_noc_jal_cc-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                ?>
                                                <span><?php
                                                    $dbname = "drainage_noc_jal_cc";
                                                    $s = $data['status'];
                                                    // Show status only if NOT 4
                                                    if (!empty($data['inspection']) && in_array(USER_ROLE, [4,5,3])) {
    echo "<a href='".SITE_ADDR."inspection_form/?rec_id={$data['id']}&db_name={$dbname}' class='btn btn-info btn-sm'>View Inspection</a><br><br>"; //view/{$data['inspection']}
}
                                                                        ...
                                                                        // echo "<br>";
                                                                            echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px; color: black;'>CERTIFICATE UPLOAD PENDING</span> <br>";
                                                                                ...
                                                                                <?php echo "<br>"; ?>
                                                                                    ...
                                                                                    <div class="mb-2">  
                                                                                        <span class="font-weight-light text-muted ">
                                                                                            PLACE / DIVISION / GOAN FOR PROPERTY:  
                                                                                        </span>
