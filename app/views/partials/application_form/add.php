...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>ADD NEW APPLICATION</strong></h4>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-drainage_connection_details-holder" class=""> 
                                                <input id="ctrl-drainage_connection_details"  value="<?php  echo $this->set_field_value('drainage_connection_details',""); ?>" type="text" placeholder="Enter Drainage Connection Details"  required="" name="drainage_connection_details"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-type_of_septic-holder" class=""> 
                                                    <select required=""  id="ctrl-type_of_septic" name="type_of_septic"  placeholder="Enter Type Of Septic "    class="custom-select" >
                                                        ...
                                                        $value = $option['value'];
                                                        $label = $option['label'];
                                                        $selected = $this->set_field_selected('type_of_septic', $value, "");
                                                        ?>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-no_of_flats-holder" class=""> 
                                                    <input id="ctrl-no_of_flats"  value="<?php  echo $this->set_field_value('no_of_flats',""); ?>" type="text" placeholder="Enter No Of Flats "  name="no_of_flats"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-demand_applicable-holder" class=""> 
                                                        <input id="ctrl-demand_applicable"  value="<?php  echo $this->set_field_value('demand_applicable',"0"); ?>" type="text" placeholder="Enter Demand Applicable"  readonly required="" name="demand_applicable"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="ctrl-upload_property_documents-holder" class=""> 
                                                            <div class="dropzone required" input="#ctrl-upload_property_documents" fieldname="upload_property_documents"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                <input name="upload_property_documents" id="ctrl-upload_property_documents" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_property_documents',""); ?>" type="text"  />
                                    ...
                                    <div class="container">
                                        <div class="row ">
                                            <div class="col-md-12 comp-grid">
                                                <div class=""><div></div>
                                                    <script>
                                                        $("#ctrl-no_of_flats").parents(".form-group").hide();
                                                        $("#ctrl-demand_applicable").parents(".form-group").hide();
                                                    </script></div>
                                                </div>
                                            </div>
                                        </div>
