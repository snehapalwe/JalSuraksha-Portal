...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['upload_property_documents'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_building_plan'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_architech_affidavit'] = array(
			"title" => "{{random}}",
		...
		$this->file_upload_settings['upload_project_consultant_report'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_property_location_map'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_full_potential_plan'] = array(
			"title" => "{{random}}",
		...
		$this->file_upload_settings['upload_construction_permission_and_cerified_map_copy'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_architect_or_project_consultant_report'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_noc_copy_given_for_construction_permission'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_map_prepared_by_licensed_plumber'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['certificate'] = array(
			"title" => "{{random}}",
			"extensions" => ".pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_inspection_document'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
